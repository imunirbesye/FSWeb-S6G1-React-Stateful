  ...
  return (
    <div className='widget-input container'>
      ...
      <div id='output' style={stil}>{
        /* ADIM 3 */ 
        useEffect(() => {document.getElementById('output').textContent = inputDegeri.toUpperCase(); })
      }</div> 
      
      <div>
		<input id='input' type='text' onChange={inputuDeğiştir} /> {/* ADIM 6 */ useEffect(() => {document.getElementById('input').setAttribute('value', inputDegeri); }) }
